    ...
    // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
    {
      ...
      groupContents: [{
...

        {
          ...
          answer: 'すべて該当',
          commentary: '黄色ブドウ球菌は好気性耐塩性グラム陽性球菌で、耐熱性黄色ブドウ球菌エンテロトキシン毒素によって様々な食品から食中毒を引き起こす。黄色ブドウ球菌は皮膚常在菌なので、手で直接触ることのあるおにぎり、ハンバーグなどは勿論、空気中に普通に漂っているため鳥刺し、シチューの調理中放置していると上から降ってきて、温度次第で繁殖してしまう。牛乳も開封すると黄色ブドウ球菌が入ってきて、冷蔵が不十分だったりすると繁殖して食中毒を引き起こすことがある。　その他食中毒の原因菌として、鶏肉関係はカンピロバクター（食中毒として最多）、シチューはウェルシュ菌、ハンバーグはO157大腸菌が有名。',
        },
        // {
        //   detailInfo: '',
        //   questionImg: [],
