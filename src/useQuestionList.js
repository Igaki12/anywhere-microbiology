    ...
    // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
    {
      ...
      groupContents: [{
        ...
        },
        {
          ...
          answer: '1,2,3が正しい',
          commentary: '梅毒などのスピロヘータはグラム染色ではよく染まらないが、外膜を持つので陽性か陰性かで問われると陰性である。梅毒は試験管での人工培養ができないので、検査は血清反応で行う。感染後すぐに初期硬結などの１期梅毒症状が出た後、発熱・バラ疹など特徴的な２期梅毒期間が数年続き、最後には心血管・鞍鼻（あんび）などに慢性的な３期梅毒症状が現れる。ペニシリンの登場により梅毒での死者は激減した。妊婦が梅毒に感染している場合、経胎盤的に胎児に伝播し先天梅毒を引き起こし、Hutchinson3徴候（実質性角膜炎・内耳性難聴・Hutchinson歯）がみられることがある　　＊鞍鼻は梅毒の症状に含まれているが、先天梅毒の症状に含まれるかどうかは確認できていない（鼻閉は先天梅毒の症状の一つ）',
        },
        {
          detailInfo: '',
          questionImg: [],
