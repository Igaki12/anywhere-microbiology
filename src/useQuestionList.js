    ...
    // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
    {
      ...
      groupContents: [{
        ...
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence: '70歳女性、近くの大学病院で慢性腎不全の治療を受けていた。軽快に伴い退院し、以後の加療 を行っていただきたい旨が書かれた紹介状を持って受診された。入院中に便からバンコマイシン耐性腸球菌(VRE)が検出されたと記載されている。入院中から現在まで下痢や発熱は認め ていない。適切な対応ははどれか（複数選択可）',
