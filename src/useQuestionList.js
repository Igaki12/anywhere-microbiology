    ...
    // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
    {
      ...
      groupContents: [{
        ...
        },
        {
          ...
          answerImg: [disc],
          answer: '1,2,5が正しい',
          commentary: 'MICはMinimum inhibitory concentration（最小発育阻止濃度）の略で、様々な濃度の薬剤を含んだ液体培地で増殖できるかどうかを調べる。薬剤感受性試験は、実習ではミュラーヒントン培地上で37度で一晩培養してから行った。ミュラーヒントン寒天培地に含まれるデンプンは寒天中に含まれる発育阻害物質を吸着する作用があり、薬剤以外の物質による発育抑制を低減する。PCR法で薬剤耐性菌は判別できる→パルスフィールドゲル電気泳動PFGEによるグリコペプチド耐性MRSA判別',
        },
        {
          detailInfo: '',
          questionImg: [],
