    ...
    // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
    {
      ...
      groupContents: [{
        ...
        },
        {
          ...
          choices: ["グラム陽性桿菌農地、リステリア属は嫌気性菌である", "破傷風金に感染する場合、咽頭・属桃に白から灰白色の偽膜形成が見られる", "人が感染する炭疽菌は95%が皮膚炭疽であり、家畜を扱う人で発症することが多い", "ボツリヌス菌は芽胞を形成する", "ウェルシュ菌は嫌気性芽胞形成菌であり、シチューなどで食中毒をきたす"],
          answerImg: [],
          answer: '',
          commentary: '',
        },
