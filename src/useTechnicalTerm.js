...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    ...
    },
    {
      ...
      explanation:
        'ブドウ球菌→MRSA/MSSA・連鎖球菌・乳酸菌・枯草菌・炭疽菌・破傷風菌・ボツリヌス菌・クロストリディオイデスディフィシル・マイコプラズマ・マイコバクテリア（結核菌などの抗酸菌）など。グラム染色で青色に染まる細菌。ペプチドグリカンに富む細胞壁が厚く、外膜を持っていない。細胞壁が比較的弱いので、球状であることが多い。桿菌は少し菌体が大きく(10μm前後)、芽胞を形成したりして病原性の高い菌が多い。',
    },
    {
      term: ['グラム陰性菌', 'gram-negative'],
      explanation:
        '淋菌・大腸菌・サルモネラ菌など。グラム染色で赤色に染まる細菌。LPSなどの外膜を持っていて、細胞壁が比較的薄い。細胞膜のペプチドグリカン層が薄い、タイコ酸がない、リポ多糖体・リポタンパク・リン脂質（外膜の構成成分）がある。→細胞壁に外膜を持つ。外膜を持つので桿状が多い（球状は淋菌ぐらい）',
    },
    {
      term: ['滅菌'],
      explanation:
    ...
    },
    {
      ...
      explanation: '直径薬1μmのぶどう房状の球菌。鞭毛・芽胞はなく、カタラーゼ陽性:酸素を分解する酵素→通性嫌気性。黄色ブドウ球菌（普通の培地に生えてきたときに黄色の色素を産生する/糖のひとつで培地に使われるマンニット分解能あり/コアグラーゼ=血漿凝固作用産生能あり/耐塩性）・表皮ブドウ球菌(CNS:Coagulase-negative staphylococci)・腐性ブドウ球菌(CNS:Coagulase-negative staphylococci)など',
    },
    {
      term: ['MHL', "マンニット食塩寒天培地"],
    ...
    },
    {
      ...
      explanation: '黄色ブドウ球菌のうちさらに耐性を獲得した多剤耐性菌。細胞膜のペニシリン結合蛋白の結合親和性が低下することによって耐性を獲得している。',
    },
    {
      term: ['Dysbiosis'],
