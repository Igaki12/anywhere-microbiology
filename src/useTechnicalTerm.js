...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    ...
    {
      term: ['天然痘'],
      explanation: '1980年、WHO二より根絶を宣言された。撲滅できたのは、天然痘は1.人以外に自然宿主を持たない、2.不顕性感染がない、3.患者の識別が容易、4.変異を起こしにくいDNAウイルス、5.きわめて有効なワクチンがあることが要因とされている。',
    },
    {
      term: ['微生物'],
    ...
    {
      term: ['EBV', "Epstein-Barr Virus"],
      explanation: '伝染性単核症（発熱・のどの痛み・リンパ節の腫れ）。成人の約95%が感染し、多発性硬化症の原因となる。',
    },
    {
      term: ['カプシド', "ヌクレオカプシド"],
    ...
    {
      term: ['水痘', "水痘・帯状疱疹ウイルス"],
      explanation: '潜伏感染するウイルス。小児で初感染（→水痘）した後、潜伏期間（完全にウイルスが死滅しているわけではないが症状が現れない）の後に免疫機能が衰えた時期に再度症状が現れる→帯状疱疹（片側だけにあらわれることが特徴）。',
    },
    {
