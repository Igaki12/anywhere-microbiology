...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    // term[0]が代表名として大きく表示される。
    {
      ...
      explanation: '新型コロナウイルスの名称。新型コロナは発症後より発症前に他人に移してしまうことの方が多いという報告があり、全員がマスクを着用することが感染対策として重要となった。感染性は発病前後が最も高いことも他のコロナウイルスと比べて特徴的：発病5日以内の濃厚接触者の二次感染割合1.0% > 発病6日以降の濃厚接触者の二次感染割合0%。新型コロナウイルスは潜伏期間も発症間隔も5日なので、発病前の感染が相当あることが疫学調査で明らかとなってきている。→濃厚接触者の発症前の隔離が必要となった。また、感染者の8割は誰にも感染させていないが、換気の悪い環境下では爆発的に感染か拡大していることが疫学的調査で明らかとなった。',
    },
    {
      term: [
        'COVID-19',
      ...
      explanation: '新型コロナウイルス感染症の名称。ウイルスの名前ではない。確定検査で報告されただけで、3年間で7億人以上が感染し、700万人近くが亡くなっている。日本国内では3000万人以上が罹患し7万人以上が死亡した。',
    },
    {
    ...
    {
      term: ['ゼンメルワイス'],
      explanation: '塩素水で手を洗う事によって、産褥熱による死亡率を30%→1%未満に劇的に低下させた。権威主義的な学会の対応により科学の発展が遅れた例としても用いられる。',
    },
    // {
    //   term: ['感染症'],
    ...
    {
      term: ['クリプトコッカス'],
      explanation: '鳥の糞などから検出される、真菌のひとつ。健常者でも発症する。肺や中枢神経（脳）に病変ができる場合が多い。ステロイド服用やエイズ罹患時で細胞性免疫不全者で特に発症しやすい。肺クリプトコッカス症は基本無症状で、すぐに治療が必要なわけではないが、中枢神経合併を避けるために髄液検査が必須→治療はアゾール系薬を投与する。クリプトコッカス髄膜炎は健常者は感染しないが、細胞性免疫低下時にのみ発症する。脳圧が異常に上昇するので治療が必要だが、治療が難しくケースバイケース。',
    },
    {
    ...
    {
      term: ['Yersinia', "ペスト", "エルシニア","黒死病"],
      explanation: 'グラム陰性腸内細菌科桿菌、ペスト菌による全身性疾患。黒死病と呼ばれ欧州で猛威をふるった。ヒトへの伝染力が極めて高く、１類感染症に分類される。現在では抗菌薬により治療が可能。ネズミとネズミノミ間の伝播が主流であるが、一部が猫・犬・人に伝染する。',
    },
    {
    ...
    },
    {
      ...
      explanation: '好気性・グラム陰性桿菌・芽胞を形成しない。偏性細胞内寄生性病原体。温泉や循環式浴槽などで市中感染が多い。４類感染症。主に肺炎を起こす。一般的に軽症で数日で治ることが多く、急激に重症となり死亡する事もある。治療しないと死亡率15％。尿中抗体検査で当たりをつけ、BCYE培地で培養が確認されれば診断となる',
    },
    {
    ...
    {
      term: ['淋菌'],
      explanation: 'グラム陰性球菌。ペニシリン耐性淋菌の増加が問題となっている。',
    },
    {
      term: ['髄膜炎菌', "N.meningitidis","Neisseria meningitidis"],
      explanation: 'グラム陰性球菌で、莢膜をもち5類感染症に分類される、流行性髄膜炎の原因菌。飛沫感染するが日本では感染例が少ない。治療としては抗菌薬の点滴。頭痛・吐き気などの症状を起こすのに、飛沫感染をするので要警戒',
    },
    {
    ...
    },
    {
      ...
      explanation: '水分を含まない飛沫（飛沫核/~5μm）により引き起こされる感染。結核・麻疹・水痘・播種性帯状疱疹（複数の支配領域に出てきた帯状疱疹）が主に該当。飛沫感染（インフルエンザ・風疹など）より少ない粒子で感染が成立する→感染力が非常に高い。',
    },
    {
    ...
    },
    {
      ...
      explanation: '単純ヘルペスウイルスはヘルペスウイルス科（エンベロープあり・二本鎖線状DNA）で、1型（口唇ヘルペス）・2型（性器ヘルペス）が存在する。神経に潜伏感染し、重症例では脳炎・髄膜炎を引き起こす。他のヘルペスウイルス科のウイルスと同様、不顕性感染や潜伏感染し宿主の抵抗力が弱まると経神経的に皮膚へ達し発疹を起こす。抗ヘルペス剤（アシクロビルなど）が有効。ヒトヘルペスウイルス6,7は乳児の突発性発疹が特徴的で、3日間高熱を出した後、おなかに発疹が出る。ヒトヘルペスウイルス8は肉腫状の発疹が出る。',
    },
    {
      term: ['サイトメガロ', "CMV"],
    ...
    {
      term: ['ジフテリア'],
      explanation: '嫌気性のグラム陽性桿菌。ジフテリア毒素（外毒素）を出す場合は２類感染症として報告しないといけない。常在菌で日和見感染症。ジフテリアだけが培養できるLoeffler培地のほか、血液寒天培地でも培養できる。できるだけ速やかに抗毒素療法を行うことが大事で、抗生物質としてペニシリンなどが有効。ジフテリアの血清は馬で作られている。予防接種として四種混合ワクチン（ジフテリア・百日咳・破傷風・ポリオ）が必須。',
    },
    {
      term: ['プロピオバクテリウム', "アクネ菌"],
      explanation: '皮膚の常在菌で、発酵により多量のプロピオン酸を産生する。',
    },
    {
      term: ['細菌性膣症'],
      explanation: '膣内常在菌叢の乱れで起こる好気性菌、嫌気性菌の混合感染。',
    },
    {
      term: ['ビフィズス菌', "Bifidobacterium"],
      explanation: 'Bから始まる。食品として利用される細菌。1属30種のみ。乳酸菌とは全くの別物。ビフィズス菌は篇性嫌気性で、糖を分解し酢酸と乳酸を3:2の割合で産生する。',
    },
    {
      term: ['乳酸菌'],
      explanation: 'パスツールが1857年に発見。20属300種以上。代謝物が50%以上乳酸である細菌を指す。ラクトバシラスは口腔・腸管・膣の正常フローラ構成菌。通性嫌気性。',
    },
    {
      term: ['プロバイオティックス'],
      explanation: '腸内細菌叢のバランスを改善することにより宿主に有益な作用をもたらす生きた微生物のこと。カルピスは生きてはいないのでプレバイオティックス。',
    },
    {
      term: ['プレバイオティックス'],
      explanation: '腸内細菌叢のバランスを完全することにより宿主に有益な作用をもたらす、生きていない食物繊維や細菌の残骸のこと。プロバイオティックスとは区別される。',
    },
    {
      term:['院内環境感染'],
      explanation:'従来の医療感染という呼び方から、介護施設や在宅など、医療が提供される環境が多様化していることを考慮して使われるようになった呼び名。在宅医療を含む医療機関において、患者が原疾患とは別に罹患した感染症。患者自身が持つ内因菌や菌交代現象も含まれる。院内感染が制御できないと、患者のQOLが低下したり入院が延長したり、医療従事者にとっても仕事が増えたり、病院にとっても医療費が増えたり訴訟の原因にもなったりする。3社に対して何もいいことがないので、感染症対策は必須。院内感染防止対策は湯厚労省が定める指針にも定められている',
    },
    {
      term:['標準予防策',"standard precautions"],
      explanation:'感染症の有無に関わらず、すべての患者に適用される予防策。すべての患者の、血液、汗を除く体液・分泌物・排泄物、皮膚、粘膜は感染性があるものとして対応する。全職員が理解して実行することが重要。素手では触らず手袋を着用して接触する。',
    },
    {
      term:['手指衛生',"手洗い"],
      explanation:'石鹸と流水による日常的手洗いのほか、医療現場では速乾性アルコール製剤・石鹸と流水による衛生学的手洗い、より厳格な手術時手洗いがある。手指が目に見えて汚染されている時は、石鹸と流水による物理的な洗い流し、そうでない場合は擦式消毒用アルコールが使われる。石鹸と流水による手洗いは細菌を1/60~1/600程度だが、アルコールの除菌効果はその10倍以上。手指衛生に必要な5つの場面として、患者に触る前、清潔/無菌操作前・体液に触れた後・患者に触れた後・患者周囲の環境に触れた後　が、WHOにより定められていて、消毒液をくまなく配置してコンプライアンスの向上に努める必要がある。',
    },
    {
      term:['個人防護具',"personal protective equipments","PPE"],
      explanation:'標準予防策に反して、血液などに接触する際に、状況に応じて使用する医療器具。ゴーグル・フェイスシールド・マスク・プラスティックエプロン・手袋・ガウンなど。手袋をして処置しても、脱ぐ時に手についてしまったり、処置中に穴が空いて侵入してしまうことがあるので、手袋をしていても手洗いは必須。接触感染・飛沫感染・空気感染（飛沫核感染）の予防に効果的。',
    },
    {
      term:['接触感染'],
      explanation:'医療関連感染で最も重要な感染経路で、代表的な薬剤耐性菌のほとんどは接触感染で院内感染を引き起こす。そのほかクロストリジウム・ディフィシル・ノロウイルス・ロタウイルス・流行性角結膜炎なども接触感染で重要な病原体。アルコールが効かないものも多く、この場合は流水と石鹸の方が有効。接触感染対策の際は、標準予防策と比べて長袖の、より厳重なガウンを用いる。',
    },
    {
      term:['AQL',"Acceptable Quality Level","許容できる不良品率"],
      explanation:'手術用手袋でも100枚中1.5枚は不良品(AQL1.5)。この割合はコンドーム(AQL0.25)より高い。このように、手袋だけでは接触感染対策を万全にすることはできない。',
    },
    {
      term:['コホーティング'],
      explanation:'病院で、多人数部屋の割り当てをする際に、なるべく感染症の患者を入れない、入れるなら同じ感染症の患者をできるだけ同じ部屋に集まるように集団隔離する必要がある。このような集団隔離のことを、コホーティングという。',
    },
    {
      term:['マスク'],
      explanation:'マスクには、サージカルマスクとN95マスクに分類される。空気感染する病原体（麻疹・水痘・結核・播種性帯状疱疹）の対策に用いるためには、サージカルマスクではなくN95マスクを用いる必要がある。N95マスクは濾過マスクとも呼ばれる。N95マスクは匂いも通さないことが示されている（N95フィットサッカリンテスト・N95ユーザーシールテスト）',
    },
    {
      term:['職業感染対策'],
      explanation:'医療従事者など病院の中で働く方々全員を感染から守る対策。具体的には、標準予防策に加えて、針刺し、切創・体液暴露への対策・ワクチン接種など。',
    },
    {
      term:['二次感染割合',"secondary attack rate"],
      explanation:'接触者のうち何人が感染したかを表す割合。高いほどその病原体の感染力が高い。',
    },
    // {
    //   term:[''],
    //   explanation:'',
